...
// It is a clean-room implementation derived from the protocol
// specification in docs/01-protocol.md and docs/02-data-model.md; comments
// cite the relevant spec section rather than any third-party source.
package homeconnect
